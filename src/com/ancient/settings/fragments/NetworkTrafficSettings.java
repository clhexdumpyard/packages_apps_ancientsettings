...
import com.ancient.settings.preferences.CustomSystemSeekBarPreference;
...
public class NetworkTrafficSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.ancient_settings_network_traffic);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.ancient_settings_network_traffic;
                    result.add(sir);
                    return result;
                }

 ...
 */
public class ColorPickerPreferenceWithIcon extends Preference implements
    ...
    public ColorPickerPreferenceWithIcon(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ColorPickerPreferenceWithIcon(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorPickerPreferenceWithIcon(Context context) {
        this(context, null);
    }
    ...
    public ColorPickerPreferenceWithIcon(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        setLayoutResource(R.layout.preference_material_settings_with_icon);
        init(context, attrs);
    }

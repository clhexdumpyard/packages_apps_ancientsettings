...
import com.anci.settings.preferences.SettingColorPickerPreference

abstract class AncientDashboardFragment: DashboardFragment() {
    override fun getMetricsCategory(): Int = MetricsProto.MetricsEvent.ANCIENT_SETTINGS
    ...
    companion object {
        const val REQUEST_KEY = "AncientDashboardFragment#RequestKey"
    }
}

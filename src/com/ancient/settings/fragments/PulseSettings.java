...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorPickerPref.setDefaultValue(AncientUtils.getThemeAccentColor(getContext()));
        ...
        if (colorMode == COLOR_TYPE_ACCENT) {
            mColorPickerPref.setNewPreviewColor(AncientUtils.getThemeAccentColor(getContext()));
        }
